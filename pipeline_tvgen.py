...
@dataclass
class TVGenPipelineOutput(BaseOutput):
	videos: Union[torch.Tensor, np.ndarray]


class TVGenPipeline(DiffusionPipeline):
	...
	def __call__(
			...
			guidance_scales: Union[float, List] = 7.5,
		...
		for guidance_scale in guidance_scales:
			...
			latents_result_list.append(latents)
		
		latents = torch.cat(latents_result_list)
		...
		return TVGenPipelineOutput(videos=video)
